...
const FIRECRAWLER_API_KEY = import.meta.env.VITE_FIRECRAWLER_API_KEY || process.env.FIRECRAWLER_API_KEY;
    ...
    return [
      {
        ...
        company: {
          ...
          flexibilityScore: 5,
          about: 'TechFlow is revolutionizing how people manage their investments through AI-driven insights.'
        },
        location: 'Remote',
        source: 'LinkedIn',
        type: 'Full-time',
        ...
        salary: { min: 140000, max: 190000, currency: 'USD', period: 'yearly', note: 'Includes equity' },
        ...
        perks: ['Health Insurance', 'Unlimited PTO', 'Home Office Stipend', 'Learning Budget'],
        compensationInsight: 'This salary is in the top 10% for this role in San Francisco.',
        glassdoorRating: 4.5,
        reviewCount: 120
      },
      {
        ...
        responsibilities: ['Create wireframes and high-fidelity mockups', 'Conduct user research'],
